...
<div class="formularios row col-xs-12 col-md-10 col-md-offset-1">
    ...
    <div class="text-center cabeceraForm">Impuetos</div>
    <form action='index.php' method='POST' id="formProductos" class="listado">
        <button id="editarImpuestos" type="submit" name="editarFacturas" class="btn-link" value='guardar'><span class="save glyphicon glyphicon-floppy-saved"></span></button>
