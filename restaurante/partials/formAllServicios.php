...
<div class="formularios row col-xs-12 col-md-10 col-md-offset-1">
    ...
    <div class="text-center cabeceraForm">Facturas Servicios</div>
    <form action='index.php' method='POST' id="formProductos" class="listado">
        <button id="editarServicios" type="submit" name="editarServicios" class="btn-link" value='guardar'><span class="save glyphicon glyphicon-floppy-saved"></span></button>
