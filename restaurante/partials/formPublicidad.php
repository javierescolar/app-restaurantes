<div id="formFlotante">
    <div id="formFlotanteCaja">
        ...
        <form action='index.php' method='POST' id="formPublicidad">
            <button id="guardarPublicidad" type="submit" name="guardarPublicidad" class="btn-link" value="Guardar Publicidad"><span class="save glyphicon glyphicon-floppy-saved"></span></button>
