<div class="formularios row col-xs-12 col-xs-12 col-md-10 col-md-offset-1">
    ...
    if (count($tickets) !== 0) {
        ...
        echo '<div class="col-xs-4 col-md-4 text-center"></div>';
        echo '<div class="col-xs-4 col-md-4 text-center"></div>';
        echo '<div class="col-xs-4 col-md-4 text-center"></div>';
        ...
        foreach ($tickets as $ticket) {
            ...
            echo '<div class="col-xs-4 col-md-4 text-center">' . $ticket['idTicket'] . '</div>';
            echo '<div class="col-xs-4 col-md-4 text-center">' . $ticket['mesa'] . '</div>';
            echo '<div class="col-xs-4 col-md-4 text-center">' . $diff->format("%H:%I") . '</div>';
